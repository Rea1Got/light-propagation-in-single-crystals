...
KNOWN_IDS = {
    "CaGdAlO4": "mp-1079296",   # тетрагональная I4/mmm (уточните, реально ли это CALGO)
    "CaYAlO4": "mp-1227264",    # аналог, вероятно
    "BaB2O4": None,      # β-BaB2O4, R3c
    # "BaB2O4": "mp-566932",      # β-BaB2O4, R3c
    "CsLiB6O10": "mp-1021352",  # CLBO, I-42d
    "LuAl3(BO3)4": "mp-504573", # R32
    "SiC": "mp-8062",           # 6H-SiC, P6₃mc (но может быть и 4H — проверьте)
    ...
    "AlN": "mp-661",            # P6₃mc
    "BN": "mp-984",             # кубический? Нужен гексагональный BN (h-BN): mp-1040425 (P6₃/mmc)
    "GaN": "mp-804",            # P6₃mc
    "LiNbO3": "mp-3731",        # R3c
    ...
    "TeO2": "mp-1986",          # α-TeO₂, P4₁2₁2
    "TiO2": "mp-2657",          # рутил, P4₂/mnm
    "ZnO": "mp-2133",           # P6₃mc
    "AlPO4": "mp-7848",         # берлинит, P3₂21
